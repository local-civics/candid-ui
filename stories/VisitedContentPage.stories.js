...
import { VisitedContentPage } from '../src/pages/content/VisitedContentPage';
import {AppLayout} from "../src/layouts/app/AppLayout";

export default {
  title: 'Page/VisitedContentPage',
  component: VisitedContentPage,
  ...
  render: (args) => <div className="h-full w-full overscroll-none font-proxima">
    <MemoryRouter>
      <AppLayout
          ...
          page=<VisitedContentPage {...args} data={args.data || MOCK_DATES}/>
      />
    </MemoryRouter>
  </div>,
}
