...
import { LikedContentPage } from '../src/pages/content/LikedContentPage';
import {AppLayout} from "../src/layouts/app/AppLayout";

export default {
  title: 'Page/LikedContentPage',
  component: LikedContentPage,
  ...
  render: (args) => <div className="h-full w-full overscroll-none font-proxima">
    <MemoryRouter>
      <AppLayout
          ...
          page=<LikedContentPage {...args} data={args.data || MOCK_DATA}/>
      />
    </MemoryRouter>
  </div>,
}
