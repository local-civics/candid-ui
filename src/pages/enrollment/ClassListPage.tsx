...
import {
  ...
  IconArchive,
  IconDotsVertical,
  IconFocusCentered, IconChalkboard, IconPlus,
  IconUserEdit, IconWorldShare, IconBarcode, IconDoorExit,
} from "@tabler/icons-react";
import { modals } from "@mantine/modals";
import { PlaceholderBanner } from "../../components/core/placeholder/PlaceholderBanner";
import { useForm as useMantineForm } from "@mantine/form";
import { ClassTransferList } from "../../components/class/ClassTransferList";
...
export type ClassListPageProps = {
  ...
  onGeneratePublicLink?: (data: ClassData) => void;
};
  ...
  return {
    ...
    editMembers: () =>
      openStage(
        1,
        <>
          <ClassTransferList data={form.values.members} onChange={(members) => setMembers(members)} />
