...
const SHARE_LINKS = [
  {
    ...
    onClick: (props: PostHeroProps) => props.onAssign && props.onAssign(),
  },
  {
    title: "Google",
  ...
  },
  {
    ...
    href: (props: PostHeroProps) => `https://api.whatsapp.com/send/?text=${encodeURIComponent(props.href||"#")}`,
  },
  {
    title: "Facebook",
  ...
  },
  {
    title: "Email",
    icon: IconAt,
    href: (props: PostHeroProps) => `mailto:?body=${encodeURIComponent(props.href||"#")}`,
  },
  {
    title: "Reddit",
    icon: IconBrandReddit,
    href: (props: PostHeroProps) => `https://www.reddit.com/submit?url=${encodeURIComponent(props.href||"#")}`,
  },
  {
    title: "LinkedIn",
